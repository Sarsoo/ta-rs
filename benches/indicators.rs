...
use finlib_ta::indicators::{
    ...
    SimpleMovingAverage, SlowStochastic, StandardDeviation, TrueRange, VolumeWeightedAveragePrice, WeightedMovingAverage,
};
use finlib_ta::{DataItem, Next};
use rand::Rng;
